...
vim.api.nvim_set_keymap('n', '<Leader>vi', ':NvimTreeToggle $HOME/dotfiles/<CR>', { noremap = true })

vim.api.nvim_set_keymap('n', '<Leader>ve', ':NvimTreeFindFileToggle<CR>', { noremap = true })
